...
<body style="background-color: #f5f5f5;">
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid">
        ...
        <li class="nav-item"><a class="nav-link active text-left text-white py-1 px-0" href="dataPenumpang.php"><i class="far fa-life-ring mx-3"></i><span class="text-nowrap mx-2">Data Penumpang</span></a></li>
        ...
        <table id="tabelDataPenumpang" class="table table-bordered table-sm" bordercolor="#ff0000">
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable(1)"><br>Nama Penumpang<br></th>
                    <th onclick="sortTable(2)"><br>Nomor Kursi<br></th>
                    <th onclick="sortTable(3)"><br>Stasiun Asal<br></th>
                    <th onclick="sortTable(4)"><br>Stasiun Tujuan<br></th>
                    <th onclick="sortTable(5)"><br>Tanggal Keberangkatan<br></th>
                    <th onclick="sortTable(6)"><br>Waktu Check In<br></th>
                    <th onclick="sortTable(7)"><br>Waktu Check Out<br></th>
                    <th onclick="sortTable(8)"><br>Status Penumpang<br></th>
                </tr>
            </thead>
            ...
            <tbody>
              ...
              <?php //connect to Database programme
                ...
                $sql = "SELECT idPenumpang, username, nokursi, stasiunAsal, stasiunTujuan, tanggal, checkin, checkout, statusPenumpang from tabeldatapenumpang";
